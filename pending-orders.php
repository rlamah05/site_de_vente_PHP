		...
		<table class="table table-bordered">
			<thead>
				<tr>
					...
					<th class="cart-total item">Mode de paiement</th>
					<th class="cart-description item">Date de commande</th>
...
<tr>
	<td colspan="9"><div class="cart-checkout-btn pull-right">
							<button type="submit" name="ordersubmit" class="btn btn-primary">
                                <a href="payment-method.php">Procéder au paiement</a></button>
...
<?php } else {?>
<tr>
<td colspan="10" align="center"><h4>Aucun résultat trouvé</h4></td>
</tr>
<?php } ?>
