...
<div class="control-group">
<label class="control-label" for="basicinput">Sous Categorie</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label" for="basicinput">Nom de Produit</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label" for="basicinput">Société de produit</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label" for="basicinput">Prix du produit avant remise</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label" for="basicinput">Prix du produit</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label" for="basicinput">Description du produit</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label" for="basicinput">Frais d'expédition du produit</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label" for="basicinput">La disponibilité des produits</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label" for="basicinput">Image du produit1</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label" for="basicinput">Image du produit2</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label" for="basicinput">Image du produit3</label>
<div class="controls">
