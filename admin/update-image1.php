...
<head>
	...
	<title>Admin| Mettre à jour l'image du produit</title>
					...
					<div class="content">
						...
						<div class="module">
							<div class="module-head">
								<h3>Mettre à jour l'image du produit 1</h3>
							</div>
...
<div class="control-group">
<label class="control-label" for="basicinput">Image actuelle du produit1</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label" for="basicinput">Nouvelle image de produit1</label>
<div class="controls">
