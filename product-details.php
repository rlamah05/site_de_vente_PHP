...
<div class="sidebar-widget hot-deals wow fadeInUp">
	<h3 class="section-title">Bonnes affaires</h3>
...
?>
					...
					<div class="products">
						...
						<a href="product-details.php?page=product&action=add&id=<?php echo $rws['id']; ?>" class="lnk btn btn-primary">Ajouter au Panier</a>
...
?>		
							<div class="rating-reviews m-t-20">
								<div class="row">
									...
									<div class="col-sm-8">
										<div class="reviews">
											<a href="#" class="lnk">(<?php echo htmlentities($num);?> Avis)</a>
										</div>
									</div>
								</div><!-- /.row -->		
							</div><!-- /.rating-reviews -->
							...
							<div class="product-social-link m-t-20 text-right">
								...
								<div class="social-icons">
						            <ul class="list-inline">
						                <li><a class="fa fa-facebook" href="https://www.facebook.com/siteguineepanorama/" target="_blank"></a></li>
						                <li><a class="fa fa-twitter" href="https://twitter.com/rlamah05" target="_blank"></a></li>
						                <li><a class="fa fa-linkedin" href="https://www.linkedin.com/feed/" target="_blank"></a></li>
...
?>
										...
										<div class="product-add-review">
											<h4 class="title">Ecrivez votre avis</h4>
...
<textarea class="form-control txt txt-review" id="exampleInputReview" rows="4" placeholder="" name="review" required="required"></textarea>
														...
														<div class="action text-right">
															<button name="submit" class="btn btn-primary btn-upper">POSTER LE COMMENTAIRE</button>
														</div><!-- /.action -->
