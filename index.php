...
<html lang="en">
	<head>
	    ...
	    <title>Page d'accueil du portail commerciale</title>
		...
		<div class="row">
			<div class="col-md-6 col-sm-4 col-lg-4">
				<div class="info-box">
					<div class="row">
						...
						<div class="col-xs-10">
							<h4 class="info-box-heading green">remboursement</h4>
						</div>
					</div>	
			...
			<div class="hidden-md col-sm-4 col-lg-4">
				<div class="info-box">
					...
					<h6 class="text">Livraison gratuite à partir de €. 500.00</h6>	
				</div>
			</div><!-- .col -->
			...
			<div class="col-md-6 col-sm-4 col-lg-4">
				<div class="info-box">
					<div class="row">
						...
						<div class="col-xs-10">
							<h4 class="info-box-heading red">Vente spéciale</h4>
						</div>
					</div>
					<h6 class="text">Tous les articles-vente jusqu'à 20% de réduction </h6>	
				</div>
			</div><!-- .col -->
		</div><!-- /.row -->
...
<!-- ============================================== INFO BOXES : END ============================================== -->		
		...
		<div id="product-tabs-slider" class="scroll-tabs inner-bottom-vs  wow fadeInUp">
			<div class="more-info-tab clearfix">
			   <h3 class="new-product-title pull-left">Produits Présentés</h3>
				<ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
					<li class="active"><a href="#all" data-toggle="tab">Tout</a></li>
					<li><a href="#books" data-toggle="tab">Livres</a></li>
					<li><a href="#furniture" data-toggle="tab">Fournitures</a></li>
				</ul><!-- /.nav-tabs -->
			</div>
