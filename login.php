...
<html lang="en">
	<head>
	    ...
	    <title>Portail d'achats | Se connecter | S'inscrire</title>
...
?>
		...
		<div class="radio outer-xs">
	  	...
	  	<button type="submit" class="btn-upper btn btn-primary checkout-page-button" name="login">S'identifier</button>
	</form>					
</div>
<!-- Sign-in -->
...
<div class="col-md-6 col-sm-6 create-new-account">
	...
	<p class="text title-tag-line">Créez votre propre compte Shopping.</p>
...
<div class="form-group">
	...
	<span class="checkout-subtitle outer-top-xs">Inscrivez-vous aujourd'hui et vous pourrez: </span>
	<div class="checkbox">
	  	<label class="checkbox">
		  	Accédez rapidement à la caisse.
		</label>
		<label class="checkbox">
		Suivez vos commandes facilement.
		</label>
		<label class="checkbox">
 Gardez une trace de tous vos achats.
		</label>
	</div>
</div>	
